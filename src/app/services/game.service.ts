  ...
  initializeRules(): void {
    const allRules: Rule[] = [
      ...
      },
      {
        ...
        validator: (password) => {
          const animals = ['perro', 'gato', 'leon', 'tigre', 'elefante', 'jirafa', 'mono', 'oso', 'lobo', 'zorro', 'aguila', 'pez', 'serpiente', 'tortuga', 'delfin', 'tiburon', 'ballena', 'loro', 'panda', 'koala'];
      ...
      {
        id: 9,
        description: 'La contraseña debe incluir los colores rojo, verde y azul en cualquier idioma',
        validator: (password) => {
          const colors = {
      ...
      {
        id: 10,
        description: 'La contraseña debe incluir un palíndromo de al menos 3 caracteres',
        validator: (password) => {
      ...
      {
        id: 11,
        description: 'La contraseña debe contener una secuencia romana (I, V, X, L, C, D, M) que represente un número mayor a 50',
        validator: (password) => {
      ...
      {
        id: 12,
        description: 'La contraseña debe contener la palabra "password" escrita al revés',
